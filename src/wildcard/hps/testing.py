...
class WildcardHPS(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        xmlconfig.file("configure.zcml", wildcard.hps, context=configurationContext)
...
WildcardHPS_INTEGRATION_TESTING = IntegrationTesting(bases=(WildcardHPS_FIXTURE,), name="WildcardHPS:Integration")
WildcardHPS_FUNCTIONAL_TESTING = FunctionalTesting(bases=(WildcardHPS_FIXTURE,), name="WildcardHPS:Functional")
...
def createObject(context, _type, id, delete_first=True, check_for_first=False, **kwargs):  # noqa: A002
